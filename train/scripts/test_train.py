...
def main(download_path: str, xpu: bool = False):
    ...
    X = Batch(
        surf_vars={
            "2t": torch.ones([1, 2, 721, 1440]),
            "10u": torch.ones([1, 2, 721, 1440]),
            "10v": torch.ones([1, 2, 721, 1440]),
            "msl": torch.ones([1, 2, 721, 1440]),
        },
        atmos_vars={
            "t": torch.ones([1, 2, 13, 721, 1440]),
            "u": torch.ones([1, 2, 13, 721, 1440]),
            "v": torch.ones([1, 2, 13, 721, 1440]),
            "q": torch.ones([1, 2, 13, 721, 1440]),
            "z": torch.ones([1, 2, 13, 721, 1440]),
        },
        static_vars={
            "z": torch.ones([721, 1440]),
            "slt": torch.ones([721, 1440]),
            "lsm": torch.ones([721, 1440]),
        },
        metadata=Metadata(
            lat=torch.linspace(90, -89, 721),
            lon=torch.linspace(0, 359, 1440),
    ...
    y = Batch(
        surf_vars={
            "2t": torch.zeros([1, 1, 721, 1440]),
            "10u": torch.zeros([1, 1, 721, 1440]),
            "10v": torch.zeros([1, 1, 721, 1440]),
            "msl": torch.zeros([1, 1, 721, 1440]),
        },
        atmos_vars={
            "t": torch.zeros([1, 1, 13, 721, 1440]),
            "u": torch.zeros([1, 1, 13, 721, 1440]),
            "v": torch.zeros([1, 1, 13, 721, 1440]),
            "q": torch.zeros([1, 1, 13, 721, 1440]),
            "z": torch.zeros([1, 1, 13, 721, 1440]),
        },
        static_vars={
            "z": torch.zeros([721, 1440]),
            "slt": torch.zeros([721, 1440]),
            "lsm": torch.zeros([721, 1440]),
        },
        metadata=Metadata(
            lat=torch.linspace(90, -89, 721),
            lon=torch.linspace(0, 359, 1440),
